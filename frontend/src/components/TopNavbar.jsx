...
import { Search, Bell, Menu, CheckCircle2, BriefcaseBusiness, MessageSquare } from "lucide-react";
  ...
  const notifications = [
    {
      ...
      text: "Your application at TechNova is under review.",
      time: "2h ago",
      unread: true,
    },
    {
      ...
      title: "New Job Match",
      text: "A new role matches 96% of your profile.",
      time: "5h ago",
      unread: true,
    },
    {
      ...
      icon: MessageSquare,
      title: "New Message",
      text: "Sarah Lin sent you a message.",
      time: "1d ago",
      unread: false,
    },
  ];
                ...
                {notifications.map((notification) => {
                  ...
                  return (
                    <button
                      ...
                      type="button"
                      className={`
                        flex w-full gap-3 border-b border-outline/5
                        px-4 py-3 text-left
                        transition-colors
                        hover:bg-surface-low
                        ${
