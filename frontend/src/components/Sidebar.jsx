    ...
    <>
      ...
      <div className="border-t border-outline/10 p-4">
        ...
        <button
            ...
            className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-semibold text-on-surface/70 transition-colors hover:bg-surface-low hover:text-on-surface"
        >
            <LogOut size={18} />
            <span>Log out</span>
        </button>
